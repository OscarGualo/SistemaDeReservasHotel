...
public class Hotel {
    ...
    private  void inicializarDatos() {
        ...
        servicios.add(new Servicio(1,"Piscina ","Piscina x", 10,EstadoServicio.DISPONIBLE ));
        servicios.add(new Servicio(2,"Spa", "SPA X",5,EstadoServicio.DISPONIBLE));
        servicios.add(new Servicio(3,"Transporte al aeropuerto", "DRIVER", 2.5,EstadoServicio.DISPONIBLE));
    }
